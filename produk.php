...
<table width="962" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
     <td width="189" rowspan="6" align="center" valign="top" bgcolor="#F7D5BO">
       <table width="262" border="0">
         <!-- Kategori -->
         <tr>
           <td width="256" bgcolor="#F7D5BO"><p><img src="IMAGE/kat.png" alt="kt" /></p> </td>
         </tr>
         <tr>
           <td bgcolor="#F7D5BO">
     ...
     <td width="539" rowspan="6" align="center" valign="top" bgcolor="#F7D5BO"><p>&nbsp;</p>

   <!--PANGGIL KATALOG PRODUK-->
 <?php
include "produk_catalog2.php";
?>

       <!--END KATALOG PRODUK-->
  
     </td>
     <td height="402" align="center" valign="top" bgcolor="#F7D5BO"><p><img src="IMAGE/shopping cart.png" alt="kt" /></p>
       <p>&nbsp;</p>
       <p><a href="keranjang_belanja.php"><img src="IMAGE/cart.png" width="170" height="170" alt="keranjang" /></a></p>
     </td>
