		...
		if ($jumlah%$limit) { 
			...
			for ($i=1;$i<=$halaman;$i++) {
				$newoffset=$limit*($i-1); 
					if ($offset!=$newoffset)
						{ 
						echo "<b><font face=\"arial\" size=\"2\"> <a href=\"index.php?produk_catalog&offset=$newoffset\">$i</a></font></B>";
					} else { 
...
<form id="form1" name="form1" method="get" enctype='multipart/form-data' action="" >
